    ...
    <div className="bg-slate-950 min-h-screen flex items-center justify-center p-6 selection:bg-amber-500/30">
      ...
      >
        <div className="text-center mb-10">
          <Link to="/" className="text-2xl font-black tracking-tighter text-gradient-accent uppercase mb-2 block text-center">
            PANKAJ ELECTRICALS
          </Link>
          <h2 className="text-2xl font-bold text-white uppercase tracking-widest text-sm text-center">Create Account</h2>
        </div>
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-xs text-slate-500 font-bold uppercase tracking-widest">or sign up with</span>
          <div className="h-px bg-white/10 flex-1"></div>
        </div>
        ...
        <p className="text-sm text-center text-slate-400">
          ...
          <Link to="/login" className="text-amber-500 font-bold hover:underline ml-1"> Sign In</Link>
        </p>
      </form>
    </div>
  );
